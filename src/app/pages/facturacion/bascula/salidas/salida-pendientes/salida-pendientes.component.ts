...
@Component({
  selector: 'app-salida-pendientes',
  templateUrl: './salida-pendientes.component.html',
  styleUrls: ['./salida-pendientes.component.css']
})
export class SalidaPendientesComponent implements OnInit {
  ...
  onAddPeso(value: DtFactura):void{
    ...
    this.router.navigate(["app/Bascula/SalidaMateriales"], navigationExtras);
  }
